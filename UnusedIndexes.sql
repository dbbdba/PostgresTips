/*Identificar índices não utilizados (ou não eficientes) no banco PostgreSql*/ WITH table_scans AS
  (SELECT tables.relid AS relid,
													          ...
													          tables.n_live_tup AS table_live_tup_count,
															   ...
															   FROM pg_stat_user_tables AS TABLES),
																								  ...
																								  (SELECT sum(table_sum_all_writes) AS database_sum_all_writes
																									   FROM table_scans),
																								                                                                                    INDEXES AS
																																		  (SELECT idx_stat.relid AS relid,
																																								          ...
																																								          idx_stat.idx_tup_read AS index_idx_tup_read,
																																									          idx_stat.idx_tup_fetch AS index_idx_tup_fetch,
																																										          pg_relation_size(idx_stat.indexrelid) AS index_bytes,
																																												   ...
																																												   JOIN pg_index AS pg_index USING (indexrelid)
																																											  ...
																																											  (SELECT indexes.schemaname AS schemaname,
																																														          ...
																																														          indexes.index_idx_scan_count AS index_idx_scan_count,
																																															          indexes.index_idx_tup_read AS index_idx_tup_read,
																																																          indexes.index_idx_tup_fetch AS index_idx_tup_fetch,
																																																	          round(CASE
																																																			                    WHEN indexes.index_idx_scan_count = 0
																																																						                         OR table_scans.table_live_tup_count = 0 THEN -1 :: NUMERIC
																																																									                    ELSE indexes.index_idx_tup_fetch :: NUMERIC / indexes.index_idx_scan_count / table_scans.table_live_tup_count * 100
																																																												                END, 2) AS idx_pct_table_fetched,
																																																														          ...
																																																														          table_scans.table_seq_scan_count AS table_seq_scan_count,
																																																															          table_scans.table_seq_tup_read AS table_seq_tup_read,
																																																																          table_scans.table_sum_all_scans AS table_sum_all_scans,
																																																																	          round((CASE
																																																																				                     WHEN table_scans.table_sum_all_scans = 0 THEN -1 :: NUMERIC
																																																																							                     ELSE indexes.index_idx_scan_count :: NUMERIC / table_scans.table_sum_all_scans * 100
																																																																											          ...
																																																																											          table_scans.table_write_update_count AS table_write_update_count,
																																																																												          table_scans.table_write_delete_count AS table_write_delete_count,
																																																																													          table_scans.table_sum_all_writes AS table_sum_all_writes,
																																																																														          round((CASE
																																																																																	                     WHEN table_scans.table_sum_all_writes = 0 THEN indexes.index_idx_scan_count :: NUMERIC
																																																																																				                     ELSE indexes.index_idx_scan_count :: NUMERIC / table_scans.table_sum_all_writes
																																																																																														   ...
																																																																																														   JOIN table_scans USING (relid)),
																																																																																																		  ...
																																																																																																		  (SELECT 1 AS grp,
																																																																																																			          'Never Used Indexes' AS reason,
																																																																																																				          *
																																																																																																					   FROM index_ratios
																																																																																																					   WHERE index_ratios.index_idx_scan_count = 0
																																																																																																					     AND index_ratios.idx_is_btree
																																																																																																					   UNION ALL SELECT 2 AS grp,
																																																																																																									   ...
																																																																																																									   UNION ALL SELECT 3 AS grp,
																																																																																																													   ...
																																																																																																													   UNION ALL SELECT 4 AS grp,
																																																																																																													                    'High-Write Large Non-Btree' AS reason,
																																																																																																															                    index_ratios.*
																																																																																																																	   FROM index_ratios,
																																																																																																																	        database_writes
																																																																																																																		   WHERE (table_sum_all_writes :: NUMERIC / COALESCE(NULLIF(database_sum_all_writes, 0), 1)) > 0.02
																																																																																																																		     AND NOT idx_is_btree
																																																																																																																		     AND index_bytes > 100000000
																																																																																																																		   UNION ALL SELECT 5 AS grp,
